...
(function () {
    ...
    juicer.tagInit = function () {
        var forstart = juicer.tags.operationOpen + 'foreach:\\s*([^}]*?)\\s*as\\s*([a-zA-Z0-9_$]*?)\\s*(=>\\s*[a-zA-Z0-9_$]*?)?' + juicer.tags.operationClose;
        var forend = juicer.tags.operationOpen + '\\/foreach' + juicer.tags.operationClose;
        var ifstart = juicer.tags.operationOpen + 'if:\\s*([^}]*?)' + juicer.tags.operationClose;
        var ifend = juicer.tags.operationOpen + '\\/if' + juicer.tags.operationClose;
        var elsestart = juicer.tags.operationOpen + 'else' + juicer.tags.operationClose;
        var elseifstart = juicer.tags.operationOpen + 'elseif:\\s*([^}]*?)' + juicer.tags.operationClose;
        ...
        this.__removeShell = function (tpl, options) {
            ...
            tpl = tpl
                ...
                .replace(juicer.settings.forstart, function ($, _name, alias, key) {
                    ...
                    _name = _name && _name.replace(/^\s*\$/, '');
                    key = key && key.replace(/^\s*\$/, '');
                    alias = alias && alias.replace(/^\s*\$/, '');
                ...
                .replace(juicer.settings.ifstart, function ($, condition) {
                    condition = condition && condition.replace(/\$([a-zA-Z0-9_]+)/g, '$1');
                    return '<% if(' + condition + ') { %>';
                })
